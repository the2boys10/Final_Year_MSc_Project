...
/**
 * @author Robert Johnson Class that creates a serversocket for clients to
 * connect to deals with reading and writing to the output and
 * inputstream.
 */
@SuppressWarnings("unused") public class Com
{
     ...
     * @param superc The predator that this object belongs to
     * @throws IOException
     */
    @SuppressWarnings("unused") public Com(int port, outBoundConnection superc) throws IOException
    {
