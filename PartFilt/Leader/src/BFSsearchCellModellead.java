...
class BFSsearchCellModellead
{

	public BFSsearchCellModellead()
	{

	}

	public int bfsSearch(CellModellead currentCell, LeaderSub superc)
	{
		for (int i = 0; i < currentCell.cells.size(); i++)
		{
			currentCell.cells.get(i).searched = false;
		}
		LinkedList<CellModellead> currentBound = new LinkedList<CellModellead>();
	...
	private int forwardNorth(CellModellead currentCell, LinkedList<CellModellead> currentBound)
	{
		if (currentCell.North != null)
		{
			if (!currentCell.North.blocking && currentCell.North.contents == 0)
	...
	private int forwardEast(CellModellead currentCell, LinkedList<CellModellead> currentBound)
	{
		if (currentCell.East != null)
		{
			if (!currentCell.East.blocking && currentCell.East.contents == 0)
	...
	private int forwardWest(CellModellead currentCell, LinkedList<CellModellead> currentBound)
	{
		if (currentCell.West != null)
		{
			if (!currentCell.West.blocking && currentCell.West.contents == 0)
	...
	private int forwardSouth(CellModellead currentCell, LinkedList<CellModellead> currentBound)
	{
		if (currentCell.South != null)
		{
			if (!currentCell.South.blocking && currentCell.South.contents == 0)
	...
	public void removeBlockers(CellModellead currentCell)
	{
		for (int i = 0; i < currentCell.cells.size(); i++)
		{
